...
2 15 * * 1-5 1-5 conda activate forecastappenv; ipython ~/python_proj/Fintech-Forecast-App/update.ipynb 10 90 'data/S&P500 tickers.csv' images/forecast_temp/forecast.png; conda deactivate >/dev/null 2>&1
...
```
[See this post on creating a `~/.bashrc_conda` file.](https://unix.stackexchange.com/questions/454957/cron-job-to-run-under-conda-virtual-environment)
